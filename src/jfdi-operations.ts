// GENERATED from docs/jfdi-operations.md — do not edit by hand.
// Edit the doc, then run: pnpm sync:guidelines
// (src/jfdi-operations.test.ts fails the gate if the two drift.)

/**
 * The operational contract JFDI ships with, compiled in so the installed CLI
